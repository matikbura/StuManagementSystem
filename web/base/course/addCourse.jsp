...
<div id="content">
	...
	<div id="contentright">
		...
		<div id="mainContent">
			<form action="${pageContext.request.contextPath}/AddCourseServlet" method="post" name="myForm">
				...
				<tr>
					...
					<td class="dataIput"><input type="text" name="courseNo" /><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">课程名称:</td>
					<td class="dataIput"><input id="courseName" name="courseName"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">学习时间:</td>
					<td class="dataIput"><input id="studyTime" name="studyTime"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">课程学分:</td>
					<td class="dataIput"><input id="grade" name="grade"/><font color="red"> * </font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 480px" class="dataIput"><input  id="term" name="term"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td id="addButton">
						<input type="submit" value="增加" style="margin: 0 auto"  onclick="return check()">
						<a href="${pageContext.request.contextPath}/ListAllCourseServlet">返回</a>
					</td>
				</tr>
				</tbody></table>
			</form>
