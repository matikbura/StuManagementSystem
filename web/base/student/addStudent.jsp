...
<div id="content">
	...
	<div id="contentright">
		...
		<div id="mainContent">
			<form action="${pageContext.request.contextPath}/AddStudentServlet" method="post" name="myForm">
				...
				<tr>
					...
					<td class="dataIput"><input type="text" name="studentNo"/><font color="red"> * </font></td>

				</tr>
				<tr>
					<td align="right" class="iput">学生姓名:</td>
					<td class="dataIput"><input id="name" name="name"/><font color="red"> * </font></td>
				</tr>
				<tr>
				...
				<tr>
					<td id="addButton">
						...
						<a href="${pageContext.request.contextPath}/ListAllStudentServlet">返回</a>
					</td>
				</tr>
				</tbody></table>
			</form>
