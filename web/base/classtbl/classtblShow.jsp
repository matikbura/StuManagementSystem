...
<div id="content">
	...
	<div id="contentright">
		...
		<div id="mainContent">
			<form action="UpdateClasstblServlet" method="post" name="myForm">
				<table style="margin: 0 auto; padding:30px 0 0 10px;border-collapse: collapse;"><tbody>
					...
					<tr>
						<td disabled="disabled" align="right" class="iput">班级编号:</td>
						<td class="dataIput"><input  name="classNo" value="${requestScope.classtbl.classNo }"/><font color="red"> * </font></td>
						<input type="hidden" name="classNo" value="${requestScope.classtbl.classNo }"/>
					</tr>
					<tr>
						<td align="right" class="iput">班级名称:</td>
						<td class="dataIput"><input id="className" name="className" value="${requestScope.classtbl.className }"/><font color="red"> * </font></td>
					</tr>
					<tr>
						<td align="right" class="iput">所属学院:</td>
						<td class="dataIput"><input id="college" name="college"  value="${requestScope.classtbl.college }"/><font color="red"> * </font></td>
					</tr>
					<tr>
						<td id="addButton">
							<input type="submit" value="修改" style="margin: 0 auto" onclick="return check()">
							<a href="ListAllClasstblServlet">返回</a>
						</td>
					</tr>
				</tbody></table>
			</form>
