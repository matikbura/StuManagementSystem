...
<div id="content">
	...
	<div id="contentright">
		...
		<div id="mainContent">
			<form action="${pageContext.request.contextPath}/AddTeacherServlet" method="post" name="myForm">
				...
				<tr>
					...
					<td class="dataIput"><input type="text" name="teacherNo" /><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">教师姓名:</td>
					<td class="dataIput"><input id="teacherName" name="teacherName"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">密码:</td>
					<td class="dataIput"><input id="password" name="password"/><font color="red"> * </font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="dataIput"><input id="education" name="education"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">家庭住址:</td>
					<td style="width: 480px" class="dataIput"><input  id="address" name="address" size=60/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">电话:</td>
					<td class="dataIput"><input id="phone" name="phone"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">EMAIL:</td>
					<td class="dataIput"><input id="email" name="email"/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td align="right" class="iput">研究方向:</td>
					<td class="dataIput"><input id="subject" name="subject"  size=60/><font color="red"> * </font></td>
				</tr>
				<tr>
					<td id="addButton">
						<input type="submit" value="增加" style="margin: 0 auto" onclick="return check()">
						<a href="${pageContext.request.contextPath}/ListAllTeacherServlet">返回</a>
					</td>
				</tr>
				</tbody></table>
			</form>
