    ...
    <div id="listAllMessage">
        ...
        <div id="pageButton">
            <c:if test="${requestScope.curPage>1}">
                <c:if test="${requestScope.courseNo!=null||requestScope.classNo!=null||requestScope.studentNo!=null||requestScope.name!=null||requestScope.scoreMin!=null||requestScope.scoreMax!=null}">
